...
use crate::{
    pretrained::openai::{OA_P50K_BASE_PATTERN, OA_R50K_BASE_PATTERN, specials},
...
pub fn oa_cl100k_base_spanning_config<T: TokenType>() -> TextSpanningConfig<T> {
    TextSpanningConfig::<T>::from_pattern(SpannerPattern::LogosCl100k)
...
pub fn oa_o200k_base_spanning_config<T: TokenType>() -> TextSpanningConfig<T> {
    TextSpanningConfig::<T>::from_pattern(SpannerPattern::LogosO200k)
